...
The `permissions` object follows Deno’s permission model and adds platform-specific capabilities. Canonical types are defined in [types.ts](file:///e:/mspbots/mb-platform-cli/packages/runtime/types.ts).
...
#### 6.2 Platform-specific permissions
